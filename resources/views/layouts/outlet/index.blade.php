        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Outelt</h4>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title mb-4">Form Data Outlet</h4>

                            <form>
                                <div class="mb-3">
                                    <label for="formrow-firstname-input" class="form-label">Nama Outlet</label>
                                    <input type="text" class="form-control" id="formrow-firstname-input" placeholder="Masukan Nama outlet">
                                </div>

                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            <label for="formrow-email-input" class="form-label">Alamat Outlet</label>
                                            <input type="text" class="form-control" id="formrow-email-input" placeholder="Masukan Alamat Outlet">
                                        </div>
                                    </div>
                                </div>
